  ...
  return (
    <motion.header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled
          ? "py-3 bg-bg-secondary/95 shadow-orange-lg backdrop-blur-md border-accent/20"
          : "py-5 bg-transparent"
      }`}
      initial={{ y: -100 }}
      animate={{ y: 0 }}
    ...
    >
      ...
      <motion.nav
        ...
        transition={{ duration: 0.3 }}
      >
        <div className="mx-4 mt-4 rounded-2xl bg-bg-secondary/95 backdrop-blur-md border border-accent/20 shadow-orange-lg overflow-hidden">
